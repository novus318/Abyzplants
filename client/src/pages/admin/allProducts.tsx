                  ...
                  <CardContent className="space-y-6">
                    <div className="flex items-center gap-4">
                      <Input
                        ...
                        className="max-w-sm"
                      />
                      <p className="text-sm text-gray-500">Total Plants: {totalCount}</p>
                    </div>
                              ...
                              <CardContent className="p-4">
                                ...
                                <div className="flex items-center mb-2">
                                  {item.offerPercentage > 0 ? (
                                    ...
                                    <>
                                    {item.sizes[0]?.pots[0] ? (<span className="text-red-500 font-semibold text-sm md:text-sm lg:text-base xl:text-lg">
                                    {(Number(item.sizes[0].price) + Number(item.sizes[0].pots[0].potPrice)).toFixed(1)} AED
                                    </span>):(<span className="text-red-500 font-semibold text-sm md:text-sm lg:text-base xl:text-lg">
